...
import com.bluemoonl.ch25camera.MainActivity.Companion.REQUEST_CODE_PERMISSIONS
import com.bluemoonl.ch25camera.databinding.ActivityMainBinding
import com.bluemoonl.ch25camera.extensions.loadCenterCrop
import com.bluemoonl.ch25camera.util.PathUtil
import java.io.File
...
class MainActivity : AppCompatActivity() {
    ...
    private val displatManager by lazy {
    ...
    private val displayListner = object : DisplayManager.DisplayListener {
    ...
    private fun startCamera(viewFinder: PreviewView) {
        displatManager.registerDisplayListener(displayListner, null)
